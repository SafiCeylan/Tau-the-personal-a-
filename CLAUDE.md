...
| **İndeksteki dosya açılamaz** | `dosya_niyeti_coz` sadece `ara` ve `gonder` işlemlerini tanıyor. "onu aç" çalışmaz — bağlam hatası değil, **olmayan yetenek**. Eklenecekse `file_send.py`'ye `ac` işlemi girmeli. |
