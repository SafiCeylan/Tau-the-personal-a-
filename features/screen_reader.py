...
_GOREVLER = (
    ...
    (('hata', 'sorun', 'neden çalışmıyor', 'bug', 'kırıldı'),
     'Bu ekrandaki hata mesajını/sorunu Türkçe açıkla ve nasıl çözüleceğini adım adım söyle.'),
    (('kod', 'yazılım', 'fonksiyon', 'metot', 'algoritma'),
     'Bu ekrandaki koda/yazılıma bakarak ne yaptığını, çalışma prensibini ve varsa hataları/iyileştirmeleri Türkçe açıkla.'),
    (('yardım et', 'çözüm', 'nasıl yapılır', 'çöz'),
     'Bu ekrandaki duruma/soruya bakarak kullanıcıya en doğru Türkçe çözümü ve yanıtı adım adım söyle.'),
